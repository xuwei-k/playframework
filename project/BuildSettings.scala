...
object BuildSettings {
  ...
  def playRuntimeSettings: Seq[Setting[?]] = Def.settings(
    ...
    mimaBinaryIssueFilters ++= Seq(
      ...
      // Twirl changed `format` variable to `$twirl__format` to avoid clashes with user defined var names
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.badRequest.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.devError.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.devNotFound.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.error.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.notFound.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.todo.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.defaultpages.unauthorized.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.checkbox.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.defaultFieldConstructor.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.form.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputCheckboxGroup.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputDate.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputFile.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.input.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputPassword.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputRadioGroup.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.inputText.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.javascriptRouter.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.jsloader.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.requireJs.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.script.format"),
      ProblemFilters.exclude[DirectMissingMethodProblem]("views.html.helper.select.format"),
